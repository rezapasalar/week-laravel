...
return array(
    ...
    */
    ...
    "dimensions" => "سایز :attribute نا معتبر است",
	"recaptcha" => "کپچا اعتبار لازم را ندارد",
    "uploaded" => "آپلود :attribute با مشکل روبرو شد",
    ...
    */
    "attributes" => array(
        ...
        "photo_path" => "تصویر",
        "photo" => "تصویر",
        "app_name_fa" => "نام اپ فارسی",
        "app_name_en" => "نام اپ انگلیسی",
        "dollar" => "دلار",
        "company_name" => "نام شرکت / فروشگاه",
        "year_birth" => "سال تولد",
        "marital_status" => "وضعیت تاهل",
        "father_job" => "شغل پدر",
        "education" => "میزان تحصیلات",
        "field" => "رشته تحصیلی",
        "willingness_work" => "تمایل به کار در",
        "work_experience_description" => "توضیحات سابقه کار",
        ...
        "roles" => "مقام ها",
        "allow_comment" => "مجوز کامنت",
        "allow_email" => "مجوز ایمیل"
    ),
);
