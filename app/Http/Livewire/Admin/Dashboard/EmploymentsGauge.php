...
class EmploymentsGauge extends Component
{
    public function render()
    {
        return <<<'blade'
            <div style="background-color: #00838f" class="flex justify-between items-center text-white rounded-md col-span-4 md:col-span-2 lg:col-span-1 px-3 py-8 text-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="950px" height="950px" viewBox="0 0 950 950" fill="currentColor" class="w-10 h-10" xml:space="preserve">
                ...
                <div class="flex flex-col">
                    <span class="text-2xl">{{ enToFa(\App\Models\Employment::count()) }}</span>
                    <small>استخدامی ها</small>
                </div>
            </div>
        blade;
    }
