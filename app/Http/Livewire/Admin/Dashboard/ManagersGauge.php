...
class ManagersGauge extends Component
{
    public function render()
    {
        return <<<'blade'
            <div style="background-color: #0288d1" class="flex justify-between items-center text-white rounded-md col-span-4 md:col-span-2 lg:col-span-1 px-3 py-8 text-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" fill="currentColor" class="w-10" viewBox="0 0 479.293 479.293" xml:space="preserve">
                ...
                <div class="flex flex-col">
                    <span class="text-2xl">{{ enToFa(\App\Models\User::count()) }}</span>
                    <small>مدیران</small>
                </div>
            </div>
        blade;
