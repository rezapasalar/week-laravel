<div 
    x-ref="scrolltop" 
    @scroll.window="if(window.pageYOffset > 1000) $refs.scrolltop.classList.remove('hidden'); else $refs.scrolltop.classList.add('hidden');" 
    @click="$dispatch('scroll:top')" 
    class="fixed z-30 text-gray-500 dark:text-gray-200 bg-opacity-75 cursor-pointer hidden bottom-5 right-5">

    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" fill="rgba(0,0,0,.5)" class="h-10 w-10" x="0px" y="0px" viewBox="0 0 300.003 300.003" xml:space="preserve">
        <g>
            <g>
