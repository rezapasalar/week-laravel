<x-admin.global.form-modal type="edit" fieldNameForOpenEditModal="username" subject="license" description="برای ایجاد لایسنس توجه داشته باشید که نام کاربری باید یکتا باشد و همچنین نام کاربری را انگلیسی و بدون فاصله انتخاب کنید.">
